...
public:
  ...
  LLVM_ABI static Type *getFloat4E2M1x2Ty(LLVMContext &C);
  LLVM_ABI static Type *getFloat4E1M2x2Ty(LLVMContext &C);
  LLVM_ABI static Type *getHiFloat4x2Ty(LLVMContext &C);
  LLVM_ABI static Type *getHiFloat8Ty(LLVMContext &C);
  LLVM_ABI static Type *getFloat8E4M3Ty(LLVMContext &C);
  LLVM_ABI static Type *getFloat8E5M2Ty(LLVMContext &C);
  LLVM_ABI static Type *getFloat8E8M0Ty(LLVMContext &C);
