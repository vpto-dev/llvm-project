...
LLVMContextImpl::LLVMContextImpl(LLVMContext &C)
    : DiagHandler(std::make_unique<DiagnosticHandler>()),
      ...
      Float4E2M1x2Ty(C, Type::Float4E2M1x2TyID),
      Float4E1M2x2Ty(C, Type::Float4E1M2x2TyID),
      HiFloat4x2Ty(C, Type::HiFloat4x2TyID),
      HiFloat8Ty(C, Type::HiFloat8TyID),
      Float8E4M3Ty(C, Type::Float8E4M3TyID),
      Float8E5M2Ty(C, Type::Float8E5M2TyID),
      Float8E8M0Ty(C, Type::Float8E8M0TyID),
